...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="wrapper col3">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Part Desc" HeaderText="Part Desc" 
                SortExpression="Part Desc" ReadOnly="True" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ERP10ConnectionString %>" SelectCommand=" SELECT &quot;JobAsmbl1&quot;.&quot;PartNum&quot;, &quot;JobOper1&quot;.&quot;AssemblySeq&quot; AS 'ASM', LEFT(&quot;JobAsmbl1&quot;.&quot;Description&quot;, 25) AS 'Part Desc',&quot;JobOper1&quot;.&quot;OprSeq&quot;, &quot;JobOper1&quot;.&quot;OpCode&quot;, &quot;OpMaster1&quot;.&quot;OpDesc&quot;, &quot;JobOpDtl&quot;.&quot;ResourceGrpID&quot; AS 'RG'
 FROM  &quot;ERP10&quot;.&quot;ERP&quot;.&quot;JobOper&quot; &quot;JobOper1&quot; 

INNER JOIN &quot;ERP10&quot;.&quot;ERP&quot;.&quot;JobAsmbl&quot; &quot;JobAsmbl1&quot; ON (&quot;JobOper1&quot;.&quot;Company&quot;=&quot;JobAsmbl1&quot;.&quot;Company&quot;) AND (&quot;JobOper1&quot;.&quot;JobNum&quot;=&quot;JobAsmbl1&quot;.&quot;JobNum&quot;) AND (&quot;JobOper1&quot;.&quot;AssemblySeq&quot;=&quot;JobAsmbl1&quot;.&quot;AssemblySeq&quot;) 

INNER JOIN &quot;ERP10&quot;.&quot;ERP&quot;.&quot;OpMaster&quot; &quot;OpMaster1&quot; ON (&quot;JobOper1&quot;.&quot;Company&quot;=&quot;OpMaster1&quot;.&quot;Company&quot;) AND (&quot;JobOper1&quot;.&quot;OpCode&quot;=&quot;OpMaster1&quot;.&quot;OpCode&quot;)

INNER JOIN &quot;ERP10&quot;.&quot;ERP&quot;.&quot;JobOpDtl&quot; ON (&quot;JobOper1&quot;.&quot;Company&quot;=&quot;JobOpDtl&quot;.&quot;Company&quot;) AND (&quot;JobOper1&quot;.&quot;JobNum&quot;=&quot;JobOpDtl&quot;.&quot;JobNum&quot;) AND (&quot;JobOper1&quot;.&quot;AssemblySeq&quot;=&quot;JobOpDtl&quot;.&quot;AssemblySeq&quot;) AND (&quot;JobOper1&quot;.&quot;OprSeq&quot;=&quot;JobOpDtl&quot;.&quot;OprSeq&quot;)

 WHERE  &quot;JobOper1&quot;.&quot;Company&quot;='RMT' AND &quot;JobOper1&quot;.&quot;JobNum&quot;=@JobNum">
        <SelectParameters>
            <asp:ControlParameter ControlID="txtJobNum" Name="JobNum" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ERP10ConnectionString %>" SelectCommand=" SELECT Key5 AS 'Date/Time', Key1 AS 'JobNum', Key2 AS 'Asm', 
        Key3 AS 'OprSeq', Key4 AS 'FLIP Type', Character06 AS 'Inspector'
 FROM   &quot;ERP10&quot;.&quot;ICE&quot;.&quot;UD01&quot; 
 WHERE  &quot;UD01&quot;.&quot;Company&quot;='RMT' AND &quot;UD01&quot;.&quot;Key1&quot;=@UDJob ORDER BY Date01 DESC">
        <SelectParameters>
            <asp:ControlParameter ControlID="txtJobNum" Name="UDJob" PropertyName="Text" />
        </SelectParameters>
    </asp:SqlDataSource>
            <br /><br />Comments<br />
            ...
            <asp:GridView ID="gvwPreviousFLIP" runat="server" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" AllowSorting="True" AutoGenerateColumns="False">
